    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">  
                ...
                <li class="sidebar-item {{request()->segment(1) == 'outcome' ? 'active' : ''}} ">
                    <a href="/outcome" class='sidebar-link'>
                        <i class="bi bi-box-arrow-right"></i>
                        <span>Pengeluaran</span>
                    </a>
                </li>
                <li class="sidebar-item {{request()->segment(1) == 'income' ? 'active' : ''}} ">
                    <a href="/income" class='sidebar-link'>
                        <i class="bi bi-box-arrow-in-right"></i>
                        <span>Pemasukan</span>
                    </a>
                </li>
                <li class="sidebar-item {{request()->segment(1) == 'debt' ? 'active' : ''}} ">
